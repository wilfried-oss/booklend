        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#author" aria-controls="author">
                        ...
                        <div class="collapse" id="author">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{ route('Author.create') }} ">Add</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#book" aria-controls="book">
                        ...
                        <div class="collapse" id="book">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{ route('Book.index') }} ">All</a></li>
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{ route('Book.create') }} ">Add</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#student" aria-controls="student">
                        ...
                        <div class="collapse" id="student">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{ route('Student.index') }} ">All</a></li>
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{ route('Student.create') }} ">Add</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#lend" aria-controls="lend ">
                            <span class="menu-title">Lend a Book</span>
                            <i class="menu-arrow"></i>
                            <i class="mdi mdi-crosshairs-gps menu-icon"></i>
                        </a>
                        <div class="collapse" id="lend">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{ route('Lend.index') }} ">All</a></li>
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{ route('Lend.create') }} ">Add</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
